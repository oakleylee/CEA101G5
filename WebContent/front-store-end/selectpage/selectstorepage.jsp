<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/front-store-end/selectpage/css/css.css" />
        ...
        <div id="mySidebar" class="sidebar">
			...
			<ul>
				...
				<li>餐點設定
					<ul>
						<li>
						<a href="<%=request.getContextPath()%>/front-store-end/menu/addmenu.jsp">新增餐點</a>
						</li>
						<li>
						<a href="<%=request.getContextPath()%>/front-store-end/menu/menulist.jsp">餐點管理</a>
						</li>
						<li>
						<a href="<%=request.getContextPath()%>/front-store-end/menu/sellstatus.jsp">可售餐點管理</a>
						</li>
					</ul>
				</li>
				<li>外帶選項設定</li>
