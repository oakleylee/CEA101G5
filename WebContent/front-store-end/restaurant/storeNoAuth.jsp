<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
    ...
    <body>
        ...
        <div class="noAuthBlock">
            <img src="<%=request.getContextPath()%>/front-store-end/restaurant/img/cryface.png" alt="">
            <p>您還不是Enak商家會員，您可以:</p>
        </div>
        <div class="noAuthBlocBtn">
            <button type="submit" onclick="location.href='<%=request.getContextPath()%>/front-customer-end/front/front.jsp'">回首頁</button>
            <button type="submit" onclick="location.href='<%=request.getContextPath()%>/front-customer-end/restaurant/application.jsp'">立刻成為商家</button>
        </div>
    </body>
