                        ...
                        <div class="envelope">
                            <div class="paper">
                                ...
                                <form METHOD="post" class="sign-up-form">
                                    <input class="text-input" type="text" name="memLice" value="${param.memLice}" />
                                    <input type="hidden" name="memPhone" value="${memLogin.memPhone}">
                                    <input type="hidden" name="memCondition" value="3">

                                    <input type="hidden" name="action" value="updateMemLice">
                                    <button class="button" type="submit" onClick="validateForm(this.form)">送出</button>
                                </form>
                            </div>
                ...
                <script>
                    ...
                    function submit(e) {
                        ...
                        setTimeout(function() {
                            ...
                            form.action = "<%=request.getContextPath()%>/back-end/member/mem.do";
                            form.submit();
                        }, 4000)
                    }
