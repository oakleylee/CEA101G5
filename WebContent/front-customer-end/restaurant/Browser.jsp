            ...
            <body>
                <div class="wrap">
                    ...
                    <div class="side-menu-all">
                        <div class="side-menu">
                            <nav>
                                ...
                                <a href=""> <i class="fas fa-bullhorn"></i>商家入口
                                </a>
                            </nav>
                        </div>
                    ...
                    <div class="store-container">
                        <div class="store-img"><img src="img//圖片/louisa.png" alt=""></div>
                        <div class="store-text">
                            <ul>
                                <li><img src="img/ICON/utensils-solid.svg" alt="" />
                                    <span><p>餐廳名稱</p></span>
                                </li>
                                <li><img src="img/ICON/star-solid.svg" alt="" />
                                    <span><p>餐廳評分</p></span>
                                </li>
                                <li><img src="img/ICON/phone-solid.svg" alt="" />
                                    <span><p>餐廳電話</p></span>
                                </li>
